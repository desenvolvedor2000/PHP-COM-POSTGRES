...
class banco {
    ...
    function conectar($dbname = "bd_funai_teste", $host = "10.0.0.36", $user = "admin", $password = "admin", $port = "5432") {
        ...
        // function conectar($dbname="cogeti", $host="localhost", $user="postgres", $password="cogeti", $port="5432"){
        // 	$conecta = pg_connect("host=$host port=$port dbname=$dbname user=$user password=$password") or die(" Erro na conex�o com o Banco de Dados");
        // 	return $conecta;
    }
    ...
    public function impressaoIndigena($sequencia) {
        $conexao = $this->conectar();
        $this->query = "SELECT nextval('" . $sequencia . "') valor";
